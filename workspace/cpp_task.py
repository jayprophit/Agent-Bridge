...
# Submit the C++ task - simple text task
task_text = 'Create a C++17 file that implements an Inventory class with add_item, remove_item, update_quantity, query_quantity methods and a test main function. Use header/source separation.'
